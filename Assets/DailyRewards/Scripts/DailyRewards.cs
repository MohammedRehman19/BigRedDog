    ...
    **/
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        public TimeSpan GetTimeDifference()
        {
            ...
            return difference.Add(new TimeSpan(0, 8, 0, 0));
        }
        ...
        public void CheckRewards()
        {
            ...
            if (!string.IsNullOrEmpty(lastClaimedTimeStr))
            {
                ...
                if (days >= 1 && days < 2)
                {
                    ...
                    GameManager.instance.Counter = 5;
                   // GameManager.instance.Counter += 1;
                    PlayerPrefs.SetInt("turn", 5);
                    GameManager.instance.TurnTxt.text =GameManager.instance.Counter+ "/5";
                    ClaimPrize();
                    GetComponent<DailyRewardsInterface>().panelReward.SetActive(false);
                    return;
                }
